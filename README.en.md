...
- Package name: `com.lambdarc.litememo`
- Main module: `:app`
...
| --- | --- | --- |
| `dev` | `com.lambdarc.litememo.dev` | Development. Debug signing; AdMob uses Google's official test IDs |
| `prod` | `com.lambdarc.litememo` | Production. Production AdMob IDs |
